...
function Contact() {
  return (
    <>
      <section id="contact" className="py-40 px-4 md:px-8 bg-[#797571]">
            ...
            <div className="flex flex-col justify-center items-start text-center">
              ...
              <div className="flex mb-12 items-start">
                ...
                <div className="text-start">
                  ...
                  <p className="my-2 text-[#242323]">I am here to help you</p>
                  <p className="text-[#242323] ">Email me at thomas.david@mail.com</p>
                </div>
              </div>
              ...
              <div className="flex mb-12 items-start">
                ...
                <div className="text-start">
                  ...
                  <p className="my-2 text-[#242323]">Mansoura, Egypt</p>
                  <p className="text-[#242323] ">serving clients worldwide</p>
                </div>
              </div>
