...
function AboutSection() {
  return (
    <>
      <section id='about' className='w-full py-[160px] px-10 bg-[#cecbc7] flex flex-col md:flex-row justify-center'>
        
        <div className='mx-auto w-[50%] px-[16px] flex flex-col items-start text-left'>
          <p className={"text-[48px]"}>Shoaib Khan</p>
          
          <p className={`${caveat.className} text-[30px] mt-2 mb-6 text-light-beige text-center lg:text-start text-3xl text-[#aca6a2]`}>Freelance Web Developer</p>
          
          <p className='text-[18px] mb-8 text-black'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Inventore, dolorum odio magni possimus corrupti molestiae labore voluptatum ut autem deleniti facilis tempora commodi dolores debitis repellendus excepturi nisi? Quisquam suscipit iste facere molestiae saepe voluptates.</p>
        
          <Button textName={"Contact Me"}/> 
        </div>

        <div className='w-[50%] sm:w-[55%] lg:w-[60%] mx-auto md:-mt-[100px] md:-mr-[40px] rounded-half flex justify-center items-center'>
          <Image src={"/myImage/profile.png"} alt='picture' width={350} height={350}></Image>
        </div>
      </section>
